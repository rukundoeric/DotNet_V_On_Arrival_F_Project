...
{
    /// <inheritdoc />
    public partial class AddCountryAndUserApplication : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserApplications_VisaApplications_VisaApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserApplications_UserId_VisaApplicationId",
                table: "UserApplications",
                columns: new[] { "UserId", "VisaApplicationId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserApplications_VisaApplicationId",
                table: "UserApplications",
